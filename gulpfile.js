...
function styles() {
   return src(
      'app/scss/style.scss') // получаем файл style.scss (может быть несколько)
...
function watching() {
   ...
   watch(['app/scss/**/*.scss'], styles) // app/scss/style.scss наблюдаем за изменениями в файле style.scss, и если есть изменения, то запускаем функцию styles
